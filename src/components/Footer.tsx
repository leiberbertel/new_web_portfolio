...
function Footer() {
  ...
  return (
    ...
    <div className='hidden md:flex justify-between w-full max-w-[1200px] mb-24'>
      <p className='montserrat font-bold'>Made with ⚡ by Leiber Bertel.</p>
      <div className='flex gap-8 montserrat font-bold'>
        <ul className='flex flex-col gap-1'>
          ...
          <li>
            <a href="/pdf/leiber_bertel_curriculum.pdf"
              download="leiber_bertel"
            >CV</a>
          </li>
          <Link
    ...
    <div className='flex md:hidden flex-col justify-between w-full max-w-[1200px] mb-12'>
      ...
      <p className='montserrat font-bold text-center'>Made with ⚡ by Leiber Bertel.</p>
      <div
        style={{ transition: 'all 0.5s' }}
        className={
          contactState
